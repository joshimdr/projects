...
*/
  ...
  def wordcount(): RDD[(String, Int)] = {
    ...
    // TODO write code here
     val wordCounts = tweetsRDD.map(x => (x, 1))
  ...
  // Hint: the Spark API provides some reduce methods
    ...
    val groupedCount = wordCounts.reduceByKey(_ + _)
...
var tweets = wordcount

// Hint: the Spark API provides a filter method
// TODO write code here

  tweets =  tweets.filter(x => (x._1.startsWith("t") || (x._1.startsWith("a") ) || (x._1.startsWith("b") ))).filter(x => (x._2>2))


  tweets.foreach(a => println(a))

//
//  for((k,v) <- tweets){
//
//    print(" "); print(" "); print(" ");
//      print(k); print("="); print(v); print(" "); print(" "); print(" ");
//
//  }
